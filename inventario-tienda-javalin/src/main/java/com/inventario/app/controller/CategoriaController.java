...
public class CategoriaController {
    ...
    private static CategoriaRepository repository = new CategoriaRepository();

    public static void getAll(Context ctx) {
        List<Categoria> recursos = repository.findAll();
        ctx.json(recursos);
    ...
    public static void getOne(Context ctx) {
        ...
        Optional<Categoria> recurso = repository.findById(id);
    ...
    public static void create(Context ctx) {
        ...
        Categoria newRecurso = ctx.bodyAsClass(Categoria.class);
    ...
    public static void update(Context ctx) {
        String id = ctx.pathParam("id");
       Categoria recursoToUpdate = ctx.bodyAsClass(Categoria.class);

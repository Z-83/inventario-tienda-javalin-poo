...
import com.inventario.app.repository.DescuentoRepository;
...
public class DescuentoController {
    ...
    private static DescuentoRepository repository = new DescuentoRepository();

    public static void getAll(Context ctx) {
        List<Descuento> recursos = repository.findAll();
        ctx.json(recursos);
    ...
    public static void getOne(Context ctx) {
        ...
        Optional<Descuento> recurso = repository.findById(id);
    ...
    public static void create(Context ctx) {
        ...
        Descuento newRecurso = ctx.bodyAsClass(Descuento.class);
    ...
    public static void update(Context ctx) {
        String id = ctx.pathParam("id");
        Descuento recursoToUpdate = ctx.bodyAsClass(Descuento.class);

...
import com.inventario.app.repository.VentaRepository;
...
public class VentaController {
    ...
    private static VentaRepository repository = new VentaRepository();

    public static void getAll(Context ctx) {
        List<Venta> recursos = repository.findAll();
        ctx.json(recursos);
    ...
    public static void getOne(Context ctx) {
        ...
        Optional<Venta> recurso = repository.findById(id);
    ...
    public static void create(Context ctx) {
        ...
        Venta newRecurso = ctx.bodyAsClass(Venta.class);
    ...
    public static void update(Context ctx) {
        String id = ctx.pathParam("id");
        Venta recursoToUpdate = ctx.bodyAsClass(Venta.class);

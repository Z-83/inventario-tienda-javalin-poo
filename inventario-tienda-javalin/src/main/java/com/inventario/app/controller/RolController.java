...
import com.inventario.app.repository.RolRepository;
...
public class RolController {
    ...
    public static void getAll(Context ctx) {
        List<Rol> recursos = repository.findAll();
        ctx.json(recursos);
    ...
    public static void create(Context ctx) {
        ...
        Rol newRecurso = ctx.bodyAsClass(Rol.class);
    ...
    public static void update(Context ctx) {
        String id = ctx.pathParam("id");
        Rol recursoToUpdate = ctx.bodyAsClass(Rol.class);

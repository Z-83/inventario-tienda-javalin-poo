...
import com.inventario.app.repository.MetodoPagoRepository;
...
public class MetodoPagoController {
        ...
        private static MetodoPagoRepository repository = new MetodoPagoRepository();

    public static void getAll(Context ctx) {
        List<MetodoPago> recursos = repository.findAll();
        ctx.json(recursos);
    ...
    public static void getOne(Context ctx) {
        ...
        Optional<MetodoPago> recurso = repository.findById(id);
    ...
    public static void create(Context ctx) {
        ...
        MetodoPago newRecurso = ctx.bodyAsClass(MetodoPago.class);
    ...
    public static void update(Context ctx) {
        String id = ctx.pathParam("id");
        MetodoPago recursoToUpdate = ctx.bodyAsClass(MetodoPago.class);

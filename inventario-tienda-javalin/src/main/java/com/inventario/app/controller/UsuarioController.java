...
import com.inventario.app.repository.UsuarioRepository;
...
public class UsuarioController {
    ...
    public static void getAll(Context ctx) {
        List<Usuario > recursos = repository.findAll();
        ctx.json(recursos);
    ...
    public static void getOne(Context ctx) {
        ...
        Optional<Usuario> recurso = repository.findById(id);
    ...
    public static void create(Context ctx) {
        ...
        Usuario newRecurso = ctx.bodyAsClass(Usuario.class);
    ...
    public static void update(Context ctx) {
        String id = ctx.pathParam("id");
        Usuario recursoToUpdate = ctx.bodyAsClass(Usuario.class);

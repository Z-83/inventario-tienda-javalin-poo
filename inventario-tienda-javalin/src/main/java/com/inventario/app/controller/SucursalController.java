...
import com.inventario.app.repository.SucursalRepository;
...
public class SucursalController {
    ...
    private static SucursalRepository repository = new SucursalRepository();

    public static void getAll(Context ctx) {
        List<Sucursal> recursos = repository.findAll();
        ctx.json(recursos);
    ...
    public static void getOne(Context ctx) {
        ...
        Optional<Sucursal> recurso = repository.findById(id);
    ...
    public static void create(Context ctx) {
        ...
        Sucursal newRecurso = ctx.bodyAsClass(Sucursal.class);
    ...
    public static void update(Context ctx) {
        String id = ctx.pathParam("id");
        Sucursal recursoToUpdate = ctx.bodyAsClass(Sucursal.class);

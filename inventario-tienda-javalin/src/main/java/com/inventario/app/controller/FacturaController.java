...
import com.inventario.app.repository.FacturaRepository;
...
public class FacturaController {
    ...
    private static FacturaRepository repository = new FacturaRepository();

    public static void getAll(Context ctx) {
        List<Factura> recursos = repository.findAll();
        ctx.json(recursos);
    ...
    public static void getOne(Context ctx) {
        ...
        Optional<Factura> recurso = repository.findById(id);
    ...
    public static void create(Context ctx) {
        Factura newRecurso = ctx.bodyAsClass(Factura.class);
    ...
    public static void update(Context ctx) {
        String id = ctx.pathParam("id");
        Factura recursoToUpdate = ctx.bodyAsClass(Factura.class);

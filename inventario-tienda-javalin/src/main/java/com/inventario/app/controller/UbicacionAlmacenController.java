...
import com.inventario.app.repository.UbicacionAlmacenRepository;
...
public class UbicacionAlmacenController {
    ...
    private static UbicacionAlmacenRepository repository = new UbicacionAlmacenRepository();

    public static void getAll(Context ctx) {
        List<UbicacionAlmacen> recursos = repository.findAll();
        ctx.json(recursos);
    ...
    public static void getOne(Context ctx) {
        ...
        Optional<UbicacionAlmacen> recurso = repository.findById(id);
    ...
    public static void create(Context ctx) {
        ...
        UbicacionAlmacen newRecurso = ctx.bodyAsClass(UbicacionAlmacen.class);
    ...
    public static void update(Context ctx) {
        String id = ctx.pathParam("id");
        UbicacionAlmacen recursoToUpdate = ctx.bodyAsClass(UbicacionAlmacen.class);
